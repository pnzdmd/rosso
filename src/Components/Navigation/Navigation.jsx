...
function Navigation() {
  return (
    <div className='container-xxl mt-3'>
      <ul className='row nav justify-content-center d-flex align-self-center border-bottom border-secondary'>
        ...
        <li className='nav-item col d-flex align-self-center'>
        ...
        <li className='nav-item col align-self-center d-flex'>
        ...
        <li className='nav-item col d-flex align-self-center'>
          <Link className='col style-text btn' to='/news'>
            Новости
          </Link>
        </li>
        {/* <li className='nav-item col d-flex align-self-center'>
